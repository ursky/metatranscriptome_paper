...
def draw_functional_pca(finalDf, var, ax):
	...
	ax.scatter(xs, ys, c=cs, s=50, edgecolors='k', marker="o", linewidth=0.5)
...
draw_functional_pca(finalDf, var, ax)

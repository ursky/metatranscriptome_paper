...
for filename in sys.argv[1:]:
	...
	if "halite" in filename or "000151265" in filename or "002284615" in filename:
		width=3
	else:
		width=1
	ax.plot(np.arange(0.0, 14, increment), data, linewidth=width, label=filename.split(".")[0])
...
plt.legend()
plt.savefig("isoelectric_points.png", dpi=300)
plt.show()

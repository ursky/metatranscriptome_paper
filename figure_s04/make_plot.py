...
##################   DRAW CONTIG PLOTS   ######################
print "plotting C..."
ax1 = fig.add_axes([0.1, 0.07, 0.37, 0.37])
plot_contigs(dna_data, rna_data, 10000, ax1, alpha=0.01)

print "plotting D..."
ax2 = fig.add_axes([0.57, 0.07, 0.37, 0.37])
plot_correlations(dna_data, rna_data, 1000, ax2)


##################   DRAW MAG PLOTS   ######################
print "plotting A..."
ax3 = fig.add_axes([0.1, 0.57, 0.37, 0.37])
plot_contigs(mag_dna_data, mag_rna_data, 1000, ax3)
ax3.set_ylabel("Mean expression or genes in MAGs (TPM)", fontsize=label_font)

print "plotting B..."
ax4 = fig.add_axes([0.57, 0.57, 0.37, 0.37])
plot_correlations(mag_dna_data, mag_rna_data, 1000, ax4)
ax4.set_ylabel("Number of MAGs", fontsize=label_font)


##################   FINISHING PLOT   ######################
ax1.annotate("C", xy=(-0.12, 1.05), xycoords="axes fraction", fontsize=heading_font)
ax2.annotate("D", xy=(-0.12, 1.05), xycoords="axes fraction", fontsize=heading_font)
ax3.annotate("A", xy=(-0.12, 1.05), xycoords="axes fraction", fontsize=heading_font)
ax4.annotate("B", xy=(-0.12, 1.05), xycoords="axes fraction", fontsize=heading_font)

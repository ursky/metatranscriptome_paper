...
def plot_contigs(dna_data, rna_data, n, ax, alpha=0.2, taxa=None):
	...
	for i,contig in enumerate(contigs):
		...
		if "Euryarchaeota" in taxon:
			c="yellow"
		elif "Cyanobacteria" in taxon:
			c="green"
		elif "Bacteroidetes" in taxon:
			c="magenta"
		elif "Proteobacteria" in taxon:
			c="blue"
		else:
			c="gray"
	...
	#ax.set_xscale("log")
	#ax.set_yscale("log")
	ax.scatter(dnas, rnas, s=20, alpha=alpha, c=colors, edgecolors='none')
...
taxa = load_tabular("contig_taxonomy.tab")

##################   DRAW CONTIG PLOTS   ######################
print "plotting A..."
ax1 = fig.add_axes([0.1, 0.57, 0.87, 0.37])
plot_contigs(dna_data, rna_data, 10000, ax1, alpha=0.05, taxa=taxa)
...
##################   DRAW MAG PLOTS   ######################
print "plotting C..."
ax3 = fig.add_axes([0.1, 0.07, 0.87, 0.37])

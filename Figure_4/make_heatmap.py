...
def drop_incomplete_paths(pathways, pathway_counts):
	...
	count_list.sort()
	min_count = count_list[len(count_list)/2]
...
print df.shape
g = sns.clustermap(df, figsize=(8,12), col_colors=lut, col_cluster=True, yticklabels=True, xticklabels=True, cmap="magma", method="weighted")

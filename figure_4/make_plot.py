...
ax1 = fig.add_axes([0.08, 0.68, 0.95, 0.25])
ax2 = fig.add_axes([0.08, 0.58, 0.76, 0.1])
ax3 = fig.add_axes([0.08, 0.2, 0.95, 0.25])
ax4 = fig.add_axes([0.08, 0.1, 0.76, 0.1])

print "making heatmaps..."
sns.heatmap(dna_df.div(dna_df.max(axis=0)), yticklabels=False, xticklabels=False, cmap="magma", cbar=True, ax=ax1, vmin=0, vmax=1)
sns.heatmap(rna_df.div(rna_df.max(axis=0)), yticklabels=False, xticklabels=False, cmap="magma", cbar=True, ax=ax3, vmin=0, vmax=1)
...
ax.text(0.45, 0.54, "Pathways", horizontalalignment='center', fontsize=14)
